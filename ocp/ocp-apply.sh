...
oc process -f ..//ocp/blog/blog-mongodb.yml | oc apply -f -
oc process -f ..//ocp/blog/blog-elasticsearch.yml | oc apply -f -
oc process -f ..//ocp/blog/blog-deployment.yml | oc apply -f -
